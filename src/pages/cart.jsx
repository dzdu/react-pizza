        ...
        <div className="container container--cart">
          {
            ...
            <div className="cart__top">
              <h2 className="content__title"><svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="cart__bottom-details">
                        <span> Total Amount: <b>{totalCount} p.</b> </span>
            ...
            <h2>Cart is empty <span role="img" aria-label="sadFace" >😕</span></h2>
            <p>
              Probalby you haven't added pizzas yet<br />
              To add <b>pizzas</b> go back to the main page and choose few  <span role="img" aria-label="angel" >😇</span>
            </p>
            <img src={empty} alt="Empty cart" />
            <Link to="/" className="button button--black"> <span>Back</span> </Link>
          </div>
          }
